...
namespace DairyIndustry.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController(IAdminRepository adminRepo, ILogisticsRepository logisticsRepo, IReportRepository reportRepo, IWebHostEnvironment env, IFinanceRepository financeRepo, IAuthRepository authRepo, IOptions<EmailSettings> settings, IConverter pdfConverter, ICollectionCenterRepository centerRepository)
        {
